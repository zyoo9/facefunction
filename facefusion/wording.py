WORDING =\
{
	...
	'batch_release_resources_limit_help': 'specifies N counter that will be used to release a frame processor resources after each N tasks',
	'batch_continue_from_line_help': 'Start batch tasks from specified line number (counts from 0)',
